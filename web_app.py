...
with st.sidebar:
    ...
    # Sizning yangi API keyingizni (AIzaSyC...) probellarsiz kiriting
...
if api_key_input:
    try:
        ...
        # SIZNING RO'YXATINGIZDAGI ENG YAXSHI MODEL:
        # Ro'yxatda 2-o'rinda turgan modelni tanladik
        ...
        with col1:
            ...
            if st.button("Tahlil qilish 🔍"):
                if not kod.strip():
                    ...
                    with st.spinner('Gemini 2.0 o\'ylamoqda...'):
                        try:
    ...
    st.warning("⚠️ Davom etish uchun API Keyni kiriting!")
